...
console.log('Task 3', addFlavor(originalFlavors, "Cookies N Cream"));
...
function getFlavorByIndex(array, index){
    let flavor = array.slice(index, index + 1)
...
console.log('Task 6', removeFlavorByName(originalFlavors, 'Banana Nut Fudge'));
